...
╠═╝║ ║║║║║╣ ╠╦╝  ╠═╣ ║  ║ ╠═╣║  ╠╩╗
╩  ╚═╝╚╩╝╚═╝╩╚═  ╩ ╩ ╩  ╩ ╩ ╩╚═╝╩ ╩
                          𝐓𝐯𝐞𝐫, Dominating since 2023
                       ╚═══╦══════════════════════════╦═══╝
                ╚╔═════════╩════════[𝓑𝓪𝓽𝓻𝓲𝓬𝓴]════════╩═════════╗╝
                ╚║ Welcome we created 𝐓𝐯𝐞𝐫 year 2023 ║╝
...
def main():
    while(True):
        cnc = input(Fore.RED +'''                   Ddos@Layer7 :[1;30m''')
        if cnc == "methods" or cnc == "Methods" or cnc == "m" or cnc == "mth" or cnc == "1":
            ...
            print(f"""
                  ...
                  [38;2;255;0;255m [1;36m𝑫𝑫𝒐𝑺,[1;31m𝑶𝒃𝒔𝒆𝒔𝒔𝒆𝒅 𝑾𝒊𝒕𝒉 𝒀𝒐𝒖 𝗫𝘂𝗮̂𝗻 𝗩𝘂̛𝗼̛𝗻𝗴
...
CLEAR   ► CLEAR TERMINAL
 ...
 #LAYER4
            ...
            print(f'''
FACEBOOK: https://www.facebook.com/Daniellahonorato04
GROUP ZALO: NULL
PAYPAL: NULL
ZALO: 0828679743
            ''')
